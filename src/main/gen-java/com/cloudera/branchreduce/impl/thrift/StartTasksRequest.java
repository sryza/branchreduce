...
public class StartTasksRequest implements org.apache.thrift.TBase<StartTasksRequest, StartTasksRequest._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("StartTasksRequest");
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(StartTasksRequest.class, metaDataMap);
  }
   ...
   */
  public StartTasksRequest(StartTasksRequest other) {
    if (other.isSetTasks()) {
...
;
  ...
  public StartTasksRequest deepCopy() {
    return new StartTasksRequest(this);
  }
  ...
  public StartTasksRequest setTasks(List<ByteBuffer> tasks) {
    this.tasks = tasks;
    return this;
  }
  ...
  public StartTasksRequest setGlobalState(byte[] globalState) {
    setGlobalState(globalState == null ? (ByteBuffer)null : ByteBuffer.wrap(globalState));
    return this;
  }

  public StartTasksRequest setGlobalState(ByteBuffer globalState) {
    this.globalState = globalState;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof StartTasksRequest)
      return this.equals((StartTasksRequest)that);
    return false;
  }

  public boolean equals(StartTasksRequest that) {
    if (that == null)
      return false;
  ...
  public int compareTo(StartTasksRequest other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    StartTasksRequest typedOther = (StartTasksRequest)other;
          ...
          if (field.type == org.apache.thrift.protocol.TType.LIST) {
            {
              ...
              this.tasks = new ArrayList<ByteBuffer>(_list4.size);
              for (int _i5 = 0; _i5 < _list4.size; ++_i5)
              {
                ByteBuffer _elem6;
                _elem6 = iprot.readBinary();
                this.tasks.add(_elem6);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    ...
    if (this.tasks != null) {
      oprot.writeFieldBegin(TASKS_FIELD_DESC);
      {
        ...
        for (ByteBuffer _iter7 : this.tasks)
        {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("StartTasksRequest(");
    boolean first = true;
